...
AlienNu::AlienNu() : AEntity("alienNuServer", 1, 1.0, 1.0) {
...
void AlienNu::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienNu::getUpdate()
{
    _commands.clear();
...
int const AlienNu::takeDamage(AEntity const &opponent)
{
...
void AlienNu::moving(double dist)
{
