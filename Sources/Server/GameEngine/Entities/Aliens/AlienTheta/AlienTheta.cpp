...
AlienTheta::AlienTheta() : AEntity("alienThetaServer", 1, 1.0, 1.0) {
...
void AlienTheta::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienTheta::getUpdate()
{
    _commands.clear();
...
int const AlienTheta::takeDamage(AEntity const &opponent)
{
...
void AlienTheta::moving(double dist)
{
