...
AlienXi::AlienXi() : AEntity("alienXiServer", 1, 1.0, 1.0) {
...
void AlienXi::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienXi::getUpdate()
{
    _commands.clear();
...
int const AlienXi::takeDamage(AEntity const &opponent)
{
...
void AlienXi::moving(double dist)
{
