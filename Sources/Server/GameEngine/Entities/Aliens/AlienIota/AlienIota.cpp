...
AlienIota::AlienIota() : AEntity("alienIotaServer", 1, 1.0, 1.0) {
...
void AlienIota::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienIota::getUpdate()
{
    _commands.clear();
...
int const AlienIota::takeDamage(AEntity const &opponent)
{
...
void AlienIota::moving(double dist)
{
