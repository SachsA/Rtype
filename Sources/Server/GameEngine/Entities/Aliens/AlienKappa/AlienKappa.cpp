...
AlienKappa::AlienKappa() : AEntity("alienKappaServer", 1, 1.0, 1.0) {
...
void AlienKappa::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienKappa::getUpdate()
{
    _commands.clear();
...
int const AlienKappa::takeDamage(AEntity const &opponent)
{
...
void AlienKappa::moving(double dist)
{
