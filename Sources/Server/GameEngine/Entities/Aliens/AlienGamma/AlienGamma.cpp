...
AlienGamma::AlienGamma() : AEntity("alienGammaServer", 1, 1.0, 1.0) {
...
void AlienGamma::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienGamma::getUpdate()
{
    _commands.clear();
...
int const AlienGamma::takeDamage(AEntity const &opponent)
{
...
void AlienGamma::moving(double dist)
{
