...
AlienZeta::AlienZeta() : AEntity("alienZetaServer", 1, 1.0, 1.0) {
...
void AlienZeta::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienZeta::getUpdate()
{
    _commands.clear();
...
int const AlienZeta::takeDamage(AEntity const &opponent)
{
...
void AlienZeta::moving(double dist)
{
