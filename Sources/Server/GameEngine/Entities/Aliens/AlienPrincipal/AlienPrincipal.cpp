...
AlienPrincipal::AlienPrincipal() : AEntity("alienPrincipalServer", 1, 1.0, 1.0) {
...
void AlienPrincipal::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienPrincipal::getUpdate()
{
    _commands.clear();
...
int const AlienPrincipal::takeDamage(AEntity const &opponent)
{
...
void AlienPrincipal::moving(double dist)
{
