...
AlienRho::AlienRho() : AEntity("alienRhoServer", 1, 1.0, 1.0) {
...
void AlienRho::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienRho::getUpdate()
{
    _commands.clear();
...
int const AlienRho::takeDamage(AEntity const &opponent)
{
...
void AlienRho::moving(double dist)
{
