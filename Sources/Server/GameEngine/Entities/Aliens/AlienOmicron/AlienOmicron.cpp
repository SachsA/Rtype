...
AlienOmicron::AlienOmicron() : AEntity("alienOmicronServer", 1, 1.0, 1.0) {
...
void AlienOmicron::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienOmicron::getUpdate()
{
    _commands.clear();
...
int const AlienOmicron::takeDamage(AEntity const &opponent)
{
...
void AlienOmicron::moving(double dist)
{
