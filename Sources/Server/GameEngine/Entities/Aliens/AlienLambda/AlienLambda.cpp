...
AlienLambda::AlienLambda() : AEntity("alienLambdaServer", 1, 1.0, 1.0) {
...
void AlienLambda::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienLambda::getUpdate()
{
    _commands.clear();
...
int const AlienLambda::takeDamage(AEntity const &opponent)
{
...
void AlienLambda::moving(double dist)
{
