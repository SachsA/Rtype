...
AlienMu::AlienMu() : AEntity("alienMuServer", 1, 1.0, 1.0) {
...
void AlienMu::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienMu::getUpdate()
{
    _commands.clear();
...
int const AlienMu::takeDamage(AEntity const &opponent)
{
...
void AlienMu::moving(double dist)
{
