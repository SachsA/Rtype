...
AlienGold::AlienGold() : AEntity("alienGoldServer", 1, 1.0, 1.0) {
...
void AlienGold::setUpdate(ACommand const &)
{

}

std::vector<std::shared_ptr<ACommand>> AlienGold::getUpdate()
{
    _commands.clear();
...
int const AlienGold::takeDamage(AEntity const &opponent)
{
...
void AlienGold::moving(double dist)
{
